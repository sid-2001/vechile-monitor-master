...
const UserManagementApi = () => {
  ...
  return (
    <Box sx={{ maxWidth: 1700, mx: 'auto', width: '100%' }}>
      ...
      <Dialog PaperProps={{ sx: { background: 'linear-gradient(135deg, rgba(15,23,42,0.96), rgba(30,41,59,0.96))', color: '#e2e8f0', border: '1px solid rgba(148,163,184,0.35)', borderRadius: 3 } }} open={editOpen} onClose={() => setEditOpen(false)} fullWidth maxWidth='md'>
